 ...
 * @author rebv1
 */
public class GUI_Modificar_Receta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 30, 200, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_Modificar_Receta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
