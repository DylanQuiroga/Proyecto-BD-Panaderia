...
public class GUI_Modificar extends javax.swing.JFrame {
    ...
    public GUI_Modificar(String rut, String rol, String rutLogin) {
        ...
        String[] datos = new DBproducto_local().cargarDatos(rut, rol);
        String[] numero = new DBproducto_local().cargarNumeros(rut);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        try {
            ...
            boolean aprobado = new DBproducto_local().modificar(rut, nombre1, nombre2, apellido1, apellido2, contrasena, direccion, horario, salario, contrato, numeros, rol, rutIngresado);
